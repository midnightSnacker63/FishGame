...
void loadGame()
{
   try
  {
    String [] data = loadStrings("save.txt");
     ...
     a.unlocked[1] = Boolean.parseBoolean(data[3]);
     a.unlocked[2] = Boolean.parseBoolean(data[4]);
     a.unlocked[3] = Boolean.parseBoolean(data[5]);
     a.unlocked[4] = Boolean.parseBoolean(data[6]);
     a.unlocked[5] = Boolean.parseBoolean(data[7]);
